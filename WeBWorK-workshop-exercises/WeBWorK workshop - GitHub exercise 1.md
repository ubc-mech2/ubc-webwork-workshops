...
3. Commit the change.
Type in a description of your change as a title for the commit (below the text area), select 'ÄúCommit directly to the <name-of-your-branch> branch', and click on 'Commit Changes'.  
