...
Go to 'ÄúBranch:master'Äù button (left hand side on the 'ÄúCode'Äù tab), type in a new name of the form "username-exercise-1", and click on 'Create branch: "new_name" from master'Äù.  Note that you can'Äôt have spaces in your branch name.  
...
3. Commit the change.
Type in a description of your change as a title for the commit (below the text area), select 'ÄúCommit directly to the <name-of-your-branch> branch', and click on 'ÄúCommit Changes'Äù.  

4. Create a pull request for the change to be merged into the master branch.
Go to the 'Pull Requests' tab.  Click on 'New Pull Request'. You may have to change your base and compare branches.  'base:' should be master.  'compare:' should be <name-of-your-branch>. You should see 'Able to merge': click on button to 'Create pull request'. You will get a chance to rename your pull request (default is commit title). Tag a workshop facilitator (add ‚Äú@adentremont‚Äù in the comments of the pull request).  Click 'Create pull request' again.  
...
Go to your pull request (Pull requests tab, 'CloseÄùd' option) and find the 'Delete branch' button.  
